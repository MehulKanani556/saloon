    ...
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10">
      <div className="flex items-center gap-4 group">
        ...
        <div className="min-w-0">
          <h1 className="text-3xl lg:text-4xl font-black text-white tracking-wide uppercase leading-none truncate md:whitespace-normal font-luxury">
            {title}
          </h1>
          <p className="text-[10px] font-black text-muted uppercase tracking-[0.3em] mt-1 opacity-60">
            {subtitle}
          </p>
        </div>
      </div>
