        ...
        >
          <div className="p-10 border-b border-slate-100 dark:border-white/5 flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-400 font-black text-[10px] uppercase tracking-widest mt-4 italic">Defining the salon's ritual classification</p>
            </div>
            <button onClick={onClose} className="p-3 bg-slate-100 dark:bg-slate-800 rounded-2xl text-slate-400 hover:text-parlour-500 transition-all hover:rotate-90">
              <X size={24} />
            </button>
          </div>
          ...
          <form onSubmit={formik.handleSubmit} className="flex-1 overflow-y-auto p-10 space-y-12 custom-scrollbar">
            <div className="space-y-4">
              ...
              <input
                ...
                className={`w-full bg-slate-50 dark:bg-slate-800/80 p-6 rounded-2xl outline-none font-bold text-slate-800 dark:text-white border-2 ${formik.touched.name && formik.errors.name ? 'border-red-400' : 'border-transparent focus:border-parlour-500/30'} transition-all shadow-inner`}
              />
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                className="w-full bg-slate-50 dark:bg-slate-800/80 p-6 rounded-2xl outline-none font-bold text-slate-800 dark:text-white border-2 border-transparent focus:border-parlour-500/30 transition-all shadow-inner min-h-[150px]"
              />
            </div>
            ...
            <div className="pt-6">
              <button
                ...
                className="w-full py-6 bg-slate-950 dark:bg-white text-white dark:text-slate-900 rounded-2xl font-black text-xs uppercase tracking-[0.3em] shadow-2xl hover:bg-parlour-600 dark:hover:bg-parlour-50 transition-all flex items-center justify-center gap-4 active:scale-95 disabled:opacity-50"
              >
                <Sparkles size={20} />
    ...
    <div className="space-y-6 md:space-y-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <button
          ...
          className="flex items-center gap-4 px-6 py-3 lg:px-10 lg:py-5 bg-gradient-to-r from-parlour-500 via-parlour-600 to-rosegold-500 text-white lg:rounded-2xl rounded-xl font-black uppercase text-xs tracking-[0.2em] shadow-xl shadow-parlour-500/20 hover:scale-[1.05] transition-all group"
        >
            ...
            >
              <div className="p-6 md:p-8 flex flex-col h-full">
                ...
                <div className="flex items-start justify-between mb-8">
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-100 dark:border-white/5 flex items-center justify-center text-parlour-500 shadow-inner group-hover:bg-parlour-500 group-hover:text-white transition-all duration-500">
                    <LayoutGrid size={28} />
                  </div>
                  <div className="flex gap-2">
                    <button
                      onClick={() => { setEditingCategory(cat); setShowForm(true); }}
                      className="w-10 h-10 flex items-center justify-center bg-slate-50 dark:bg-slate-800 text-slate-400 hover:text-parlour-500 rounded-xl transition-all border border-transparent hover:border-parlour-200 dark:hover:border-parlour-800"
                    >
                      <Pencil size={16} />
                    </button>
                    <button
                ...
                <div className="flex flex-col flex-grow">
                  <h3 className="text-xl md:text-2xl font-black text-slate-900 dark:text-white tracking-tighter uppercase italic mb-4 leading-none group-hover:text-parlour-500 transition-colors">
                    {cat.name}
                  </h3>
                ...
                <div className="mt-auto pt-6 border-t border-slate-50 dark:border-white/5 flex items-center justify-between">
                  ...
                  <div className="bg-parlour-50/50 dark:bg-parlour-900/10 px-3 py-1.5 rounded-xl border border-parlour-100 dark:border-parlour-900/20 shadow-sm">
                    <span className="text-[9px] font-black text-parlour-500 uppercase tracking-widest italic">
                      Institutional
                    </span>
                  </div>
                </div>
