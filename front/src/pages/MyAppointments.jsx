      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between gap-12 pb-16 border-b border-white/5 relative">
          ...
          <motion.button
            ...
            className="w-20 h-20 bg-dark-card border border-white/10 rounded-2xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] flex items-center justify-center group relative overflow-hidden"
          >
            ...
            <AnimatePresence mode="popLayout">
              {appointments.map((app, index) => (
                <motion.div
                  ...
                  className="bg-dark-card backdrop-blur-3xl p-10 md:p-14 border border-white/10 shadow-[0_50px_100px_-20px_rgba(0,0,0,1)] rounded-2xl ring-1 ring-white/5 hover:ring-primary/30 transition-all duration-1000 group flex flex-col lg:flex-row lg:items-center gap-16 relative overflow-hidden"
                >
                  ...
                  <div className="flex-1 space-y-12 relative z-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                      <div className="flex items-center gap-6 group/sub">
                        <div className="w-16 h-16 bg-background/60 rounded-2xl text-muted/30 group-hover/sub:text-primary group-hover/sub:border-primary/40 group-hover/sub:scale-110 transition-all duration-700 border border-white/5 flex items-center justify-center shadow-inner">
                      ...
                      <div className="flex items-center gap-6 group/sub">
                        <div className="w-16 h-16 bg-background/60 rounded-2xl text-muted/30 group-hover/sub:text-primary transition-all duration-700 border border-white/5 flex items-center justify-center shadow-inner">
                      ...
                      <div className="flex items-center gap-6 group/sub">
                        <div className="w-16 h-16 bg-background/60 rounded-2xl border border-white/5 flex items-center justify-center shadow-inner group-hover/sub:border-primary/20 transition-all duration-700">
