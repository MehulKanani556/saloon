    ...
    <div className="space-y-6 md:space-y-12">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="bg-white dark:bg-slate-900 px-5 py-3.5 rounded-2xl border border-slate-100 dark:border-white/5 shadow-2xl flex items-center gap-4 w-full md:w-80 group focus-within:border-parlour-500/50 transition-all">
            <Search size={18} className="text-slate-400 group-focus-within:text-parlour-500 transition-colors" />
            <input
              type="text"
                    ...
                    <td className="px-4 md:px-8 md:py-8 py-4">
                      <div className="space-y-3">
                        <p className="text-[11px] font-bold text-slate-600 dark:text-slate-300 flex items-center gap-3 whitespace-nowrap">
                          <Mail size={14} className="text-parlour-500" />
                          {client.email}
                        </p>
                        <p className="text-[11px] font-bold text-slate-600 dark:text-slate-300 flex items-center gap-3 whitespace-nowrap">
                          <Phone size={14} className="text-parlour-500" />
                          {client.phone}
                        </p>
                      </div>
                    </td>
                    ...
                    <td className="px-4 md:px-8 md:py-8 py-4 text-right">
                      <div className="flex items-center justify-start gap-2 transition-opacity">
                        ...
                        <button
                          ...
                          className="p-3 bg-slate-50 dark:bg-slate-800 rounded-2xl text-slate-400 hover:text-parlour-500 transition-all border border-transparent hover:border-parlour-500/20"
                        >
                          <Eye size={18} />
                        </button>
                        <button
                ...
                <div className="flex-1 overflow-y-auto px-10 py-8 space-y-12 custom-scrollbar">
                  <div className="flex flex-col items-center">
                    <div className="relative group">
                      <div className="w-40 h-40 rounded-2xl bg-slate-50 dark:bg-slate-800 border-4 border-slate-100 dark:border-white/5 flex items-center justify-center text-slate-300 dark:text-slate-600 shadow-inner overflow-hidden transition-all group-hover:border-parlour-500/20">
                        {imagePreview ? (
                      ...
                      <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-parlour-600 rounded-2xl flex items-center justify-center text-white shadow-xl border-4 border-white dark:border-slate-900 group-hover:scale-110 transition-transform">
                        <Plus size={20} />
                      </div>
                    </div>
              ...
              >
                <div className="relative h-72 w-full overflow-hidden">
                  ...
                  <div className="absolute bottom-10 left-10">
                    <div className="px-3 py-1 bg-parlour-600 text-white text-[9px] font-black uppercase tracking-widest rounded-lg inline-block mb-3 italic">Premium Gentleman</div>
                ...
                <div className="flex-1 overflow-y-auto p-10 space-y-12 custom-scrollbar text-slate-800 dark:text-white">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-8 bg-slate-50 dark:bg-slate-800 rounded-2xl flex items-center justify-between group hover:bg-parlour-500/5 transition-all cursor-pointer">
                      <div>
                      ...
                      <div className="w-12 h-12 bg-white dark:bg-slate-700 rounded-2xl flex items-center justify-center text-slate-400 group-hover:text-parlour-500 transition-colors shadow-sm">
                        <Phone size={20} />
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                      {appointments.filter(app => app.client?._id === profileClient._id).length > 0 ? (
                        appointments
                          ...
                          .map((app, idx) => (
                            <div key={app._id} className="p-6 bg-slate-50 dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-white/5 group hover:bg-parlour-500/5 transition-all">
                ...
                <div className="p-10 border-t border-slate-100 dark:border-white/5 flex gap-4 bg-slate-50/50 dark:bg-slate-800/10">
                  <button
                    ...
                    className="flex-1 py-5 bg-slate-900 dark:bg-slate-800 text-white rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] hover:bg-parlour-600 transition-all shadow-xl active:scale-95"
                  >
                    Refine Identity
                  </button>
                  <button
